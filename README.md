...
XX- See the image received from the server, including its title, likes and comments when the page loads
XX- Click on the heart icon to increase image likes, and still see them when I reload the page
XX- Add a comment (no persistance needed)
